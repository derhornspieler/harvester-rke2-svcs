...
- Harbor (`harbor.example.com`) is the pull-through cache — never pull directly from Docker Hub, GHCR, or quay.io
...
- Domain: `example.com` — use `_subst_changeme()` for domain substitution
