...
${OCI_CHART_PROMETHEUS_CRDS} ${OCI_CHART_CNPG} ${OCI_CHART_REDIS_OPERATOR}
${OCI_CHART_CERT_MANAGER} ${OCI_CHART_VAULT} ${OCI_CHART_EXTERNAL_SECRETS}
${OCI_CHART_EXTERNAL_DNS} ${OCI_CHART_PROMETHEUS_STACK} ${OCI_CHART_HARBOR}
${OCI_CHART_ARGOCD} ${OCI_CHART_ARGO_ROLLOUTS} ${OCI_CHART_ARGO_WORKFLOWS}
${OCI_CHART_KEYCLOAKX} ${OCI_CHART_GITLAB} ${OCI_CHART_GITLAB_RUNNER}
