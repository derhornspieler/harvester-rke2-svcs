...
git remote add gitlab git@gitlab.aegisgroup.ch:infra_and_platform_services/harvester-rke2-svcs.git
...
```bash
cd /tmp
git clone git@gitlab.aegisgroup.ch:infra_and_platform_services/harvester-rke2-svcs.wiki.git
...
Navigate to: `https://gitlab.aegisgroup.ch/infra_and_platform_services/harvester-rke2-svcs/-/wikis/home`
