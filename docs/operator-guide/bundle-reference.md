...
- **storage-autoscaler** -- Auto-expands PVCs when usage exceeds threshold; v0.3.0 adds `controllerRef` for CNPG-aware expansion on offline-CSI environments (Harvester/Longhorn)
