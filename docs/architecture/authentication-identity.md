...
1. A user visits any protected service URL (e.g., `prometheus.dev.example.com`)
...
curl -sf https://keycloak.dev.example.com/realms/platform/.well-known/openid-configuration | jq .
